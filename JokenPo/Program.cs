...
namespace JokenPo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //programa 2
            int pontin = 0;
            string[] rank = { "Rodrigo", "TonyStark", "Homem Aranha", "Viuva Negra", "Feiticeira Scarlat", "Hulk" };
            ...
            Console.WriteLine("                          'Y1111$'               1111gg3'                   ");
            Console.WriteLine("                          $llll'                Y %%%%");
            Console.WriteLine("                          $llllF                                           ");
            Console.WriteLine("                          lllll                                    ");
            Console.WriteLine("                          lllll          ,g@,g@$$ppp$$@`                       ");
            Console.WriteLine("                          ]llllk          ,g@$$,g@$$$$@`                         ");
            ...
            Console.WriteLine("                               RODRIGO MESQUITA");
            ...
            do
            {
                ...
                switch (s)
                {
                    ...
                    case 4:
                        ...
                        Console.WriteLine("       d8,          d8b                                                   ");
                        Console.WriteLine("      `8P           ?88                                                   ");
                        Console.WriteLine("      d88            88b   d88'        d88                                      ");
                        Console.WriteLine("      d88   d8888b   888  d88' d8888b  88bd88b ?88,.d88b, d8888b          ");
                        Console.WriteLine("      ?88  d8P' ?88  888bd8P' d8b_,dP  88P' ?8b`?88'  ?88d8P' ?88         ");
                        Console.WriteLine("       88b 88b  d88 d88888b   88b     d88   88P  88b  d8P88b  d88         ");
                        Console.WriteLine("       `88b`?8888P'd88' `?88b,`?888P'd88'   88b  888888P'`?8888P'         ");
